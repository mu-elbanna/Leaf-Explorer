...
public class FileCopyDialog extends AlertDialog.Builder {

    public FileCopyDialog(final Context context, final List<Uri> selectedItemList, final DocumentFile destination, final Listener listener) {
        super(context);

        setTitle("Copy");
        setMessage(getContext().getResources().getQuantityString(R.plurals.ques_copyFile, selectedItemList.size(), selectedItemList.size()));
