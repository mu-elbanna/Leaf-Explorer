...
import com.leaf.explorer.file_share.activity.HomeActivity;

public class AppPermissionRequest extends AlertDialog.Builder
{
    public PermissionRequest mPermissionQueue;

    public AppPermissionRequest(final AppActivity activity,
    ...
    public static AlertDialog requestIfNecessary(AppActivity activity,
                                                 ...
                                                 boolean killActivityOtherwise)
    {
        return ActivityCompat.checkSelfPermission(activity, permissionQueue.permission) == PackageManager.PERMISSION_GRANTED
                ? null
                : new AppPermissionRequest(activity, permissionQueue, killActivityOtherwise).show();
    }
