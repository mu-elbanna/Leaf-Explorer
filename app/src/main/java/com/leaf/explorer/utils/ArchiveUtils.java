                ...
                try {
                    ...
                    synchronized (lock) {
                        if (is != null) {
                            ...
                            archive.title.setText(context.getString(R.string.files_archiving) + " " + JavaUtils.formatSize(context, a) + context.getString(R.string.per_second) + ", " + e);
                    ...
                    context.sendBroadcast(new Intent(AppConfig.REFRESH_UPDATE));
