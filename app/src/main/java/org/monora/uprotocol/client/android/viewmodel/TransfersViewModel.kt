...
import org.monora.uprotocol.client.android.data.*
...
class TransfersViewModel @Inject internal constructor(
    ...
    fun deleteTransferHistory(transferDetail: TransferDetail) {
        viewModelScope.launch(Dispatchers.IO) {
            transferRepository.delete(getTransfer(transferDetail.id)!!)
        }
    }
    fun deleteTransferHistory(sharedText: SharedText) {
        viewModelScope.launch(Dispatchers.IO) {
