...
object Activities {
    ...
    fun getLeafSharedPreferences(context: Context, name: String): SharedPreferences {
        return context.getSharedPreferences(name, 0)
    }

    fun getLeafPrefBoolean(context: Context, name: String, defValue: Boolean): Boolean {
        val prefs = getLeafSharedPreferences(context, name)

        return prefs.getBoolean(name, defValue)
    }

    fun editBooleanPreferences(context: Context, name: String, value: Boolean) {
        val editor = getLeafSharedPreferences(context, name).edit()
