...
class AboutFragment : Fragment(R.layout.layout_about) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        view.findViewById<View>(R.id.authorWeb).setOnClickListener {
            startActivity(Intent(Intent.ACTION_VIEW).setData(Uri.parse(AppConfig.URI_SHIV_SHAMBHU_DONATE)))
        }
        view.findViewById<View>(R.id.authorWeb1).setOnClickListener {
            startActivity(Intent(Intent.ACTION_VIEW).setData(Uri.parse("https://github.com/Shiv-Shambhu/Leaf-Explorer/blob/main/Project-Credit.md")))
        }
        view.findViewById<View>(R.id.authorGit).setOnClickListener {
            startActivity(Intent(Intent.ACTION_VIEW).setData(Uri.parse("https://github.com/Mahadev-code")))
        }
        view.findViewById<View>(R.id.authorGit1).setOnClickListener {
            startActivity(Intent(Intent.ACTION_VIEW).setData(Uri.parse("https://github.com/Shiv-Shambhu/Leaf-Explorer/blob/main/Project-Credit.md")))
        }
    }
